# Generated by Powerlevel10k configuration wizard on 2026-01-28 at 16:29 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='󰄰'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # Styling for incomplete and stale Git sta 
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR='#7f849c'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#f9e2af'POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=
